...
class ResponsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create response" do
    assert_difference("Response.count") do
      post responses_url, params: { response: { discord_uid: @response.discord_uid, prompt_id: @response.prompt_id } }
    end
  ...
  test "should update response" do
    patch response_url(@response), params: { response: { discord_uid: @response.discord_uid, prompt_id: @response.prompt_id } }
